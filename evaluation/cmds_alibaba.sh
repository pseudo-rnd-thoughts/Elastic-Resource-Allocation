...
qsub -v file='greedy',model_file='alibaba',num_tasks='15',num_servers='3',extra='non-elastic optimal' run_script.sh
qsub -v file='greedy',model_file='alibaba',num_tasks='20',num_servers='4',extra='non-elastic optimal' run_script.sh
...
qsub -v file='greedy',model_file='alibaba',num_tasks='50',num_servers='10',extra='greedy' run_script.sh
qsub -v file='greedy',model_file='alibaba',num_tasks='75',num_servers='15',extra='greedy' run_script.sh
