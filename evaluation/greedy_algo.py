...
def best_algorithms_test(model_dist: ModelDist, repeat: int, repeats: int = 200,
...
def allocation_test(model_dist: ModelDist, repeat: int, repeats: int = 50,
    ...
    print(f'Allocation testing using the results of the greedy, relaxed and '
          f'optimal {model_dist.num_tasks} tasks and {model_dist.num_servers} servers')
    data = []
