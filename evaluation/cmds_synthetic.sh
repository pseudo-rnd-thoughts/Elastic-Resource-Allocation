...
qsub -v file='greedy',model_file='synthetic',num_tasks='15',num_servers='3',extra='fixed optimal' run_script.sh
...
qsub -v file='greedy',model_file='synthetic',num_tasks='80',num_servers='16',extra='time limited' run_script.sh
qsub -v file='greedy',model_file='synthetic',num_tasks='160',num_servers='32',extra='time limited' run_script.sh
