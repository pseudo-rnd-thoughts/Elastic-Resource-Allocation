...
def realistic_scaling(model_dist: ModelDistribution, repeat_num: int,
                      scalings: List[Tuple[int, int, int]] = (), repeats: int = 10):
    scaling_results = {}
    pp = pprint.PrettyPrinter()
    filename = results_filename('realistic', model_dist, repeat_num)
...
if __name__ == "__main__":
    ...
    realistic_scaling(ModelDistribution(args.file, args.tasks, args.servers), args.repeat,
