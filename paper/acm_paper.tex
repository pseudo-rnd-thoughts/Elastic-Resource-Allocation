...
\begin{document}
    ...
    \keywords{Edge clouds; elastic resources; auctions}
    ...
    \input{sections/3_problem_formulation.tex}
    \input{sections/4_algorithms.tex}
    \input{sections/5_evidence.tex}
