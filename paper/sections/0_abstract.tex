\begin{abstract}
    Edge Cloud Computing enables computational tasks to be processed at the edge of the network using limited
    ...
    This is due to time taken for an operation to occur is generally proportional to the allocated resource. This, however,
